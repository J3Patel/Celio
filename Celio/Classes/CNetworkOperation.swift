...
open class CNetworkOperation: CGroupOperation {

    private let networkRequest: CNetworkRouter
    open var dataFetched: Data?

    public init(networkRequest: CNetworkRouter) {
    ...
    override open func operationDidFinish(operation: Operation, withErrors errors: [NSError]) {
